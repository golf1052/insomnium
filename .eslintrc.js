...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-empty-interface': OFF(UNKNOWN),
    '@typescript-eslint/no-empty-object-type': OFF(UNKNOWN),
    '@typescript-eslint/no-namespace': [ERROR, { allowDeclarations: true }],
    '@typescript-eslint/no-redeclare': ERROR,
    '@typescript-eslint/no-require-imports': OFF(UNKNOWN),
    '@typescript-eslint/no-unsafe-function-type': OFF(UNKNOWN),
    '@typescript-eslint/no-unused-expressions': OFF(UNKNOWN),
    '@typescript-eslint/no-unused-vars': OFF(UNKNOWN),
    '@typescript-eslint/no-wrapper-object-types': OFF(UNKNOWN),
